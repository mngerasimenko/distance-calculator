...
public class MatrixDistance implements Calculations{
    ...
    public MatrixDistance(HashMap cityMap, City fromCity, City toCity) {
    ...
    public void searchPath(City fCity, City toCity) {
        ...
        HashSet hashSet = cityMap.get(fCity);
        hashSet.forEach(pair -> {
            System.out.println(((DistanceStorage.DistanceToCity) pair).getKey());
            if (((DistanceStorage.DistanceToCity) pair).getKey() == toCity) {
                System.out.println("1111111111111111111111111111");
                return;
            } else searchPath((City) ((DistanceStorage.DistanceToCity) pair).getKey(), toCity);
        });
